...
```bash
python ~/.claude/skills/paper-writing/citation-management/scripts/validate_citations.py \
...
```bash
python ~/.claude/skills/research-workflow/deep-research/scripts/bibtex_manager.py \
  --jsonl paper_db.jsonl --output references.bib
```

### Search for a specific paper to add
```bash
python ~/.claude/skills/research-workflow/deep-research/scripts/search_semantic_scholar.py \
...
```bash
python ~/.claude/skills/paper-writing/citation-management/scripts/harvest_citations.py \
...
## Related Skills
- Upstream: [literature-search](../literature-search/), [deep-research](../research-workflow/deep-research/)
