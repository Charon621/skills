...
git clone <本仓库 URL> .claude/skills/research-workflow/patent-disclosure-skill
```

或使用本地路径复制到 `.claude/skills/research-workflow/patent-disclosure-skill`。
...
| macOS / Linux | `~/.cursor/skills/research-workflow/patent-disclosure-skill/` |

示例（将仓库克隆到全局技能目录）：

```bash
mkdir -p ~/.cursor/skills
git clone <本仓库 URL> ~/.cursor/skills/research-workflow/patent-disclosure-skill
```
...
`<项目根>/.cursor/skills/research-workflow/patent-disclosure-skill/`
