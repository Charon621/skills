...
```bash
python skills/nature-suite/nature-figure/scripts/plot_templates.py volcano \
  --input results.csv --gene-col gene --effect-col log2fc --p-col padj \
  --output figures/volcano

python skills/nature-suite/nature-figure/scripts/plot_templates.py roc \
  --input roc.csv --fpr-col fpr --tpr-cols model_a,model_b \
  --output figures/roc

python skills/nature-suite/nature-figure/scripts/plot_templates.py dotplot \
