...
```bash
# Python source
python skills/nature-suite/nature-figure/scripts/validate_figure.py path/to/figure.py

# R, R Markdown, or Quarto source
python skills/nature-suite/nature-figure/scripts/validate_figure.py path/to/figure.R

# Machine-readable report or stricter warning gate
python skills/nature-suite/nature-figure/scripts/validate_figure.py path/to/figure.py --json
python skills/nature-suite/nature-figure/scripts/validate_figure.py path/to/figure.py --strict
```
